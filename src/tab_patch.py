...
def focus(_widget, event):
    ...
    if event.in_:
        ...
        App().set_accels_for_action("app.one(1)", ["1"])
        App().set_accels_for_action("app.two(2)", ["2"])
        App().set_accels_for_action("app.three(3)", ["3"])
        App().set_accels_for_action("app.four(4)", ["4"])
        App().set_accels_for_action("app.five(5)", ["5"])
        App().set_accels_for_action("app.six(6)", ["6"])
        App().set_accels_for_action("app.seven(7)", ["7"])
        App().set_accels_for_action("app.eight(8)", ["8"])
        App().set_accels_for_action("app.nine(9)", ["9"])
        App().set_accels_for_action("app.zero(0)", ["0"])
